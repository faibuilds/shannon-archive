...
(function checkPrivacy() {
  ...
  // Crowley, Brian Berthold, Matias Soto (07.2026), Pierre Gravel and Bob
  // Cuyt (08.2026). Cuyt is the first to arrive through the crew remarks
  // form rather than a LinkedIn comment, and the form's tickbox is the
  // cleanest consent we hold: it names the person, the title and the right
  // to removal. Allen Crane asked but not yet replied, so he stays in the
